-- Add functions to get unread message count for tasks
...
'Get the count of unread messages for a user across multiple tasks (batch query). Returns a table with task_id and unread_count. Only assigner ↔ assignee can have unread messages.';
